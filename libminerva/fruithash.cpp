...
//void truehash_search(uint64_t dataset[], uint8_t mining_hash[], uint64_t start_nonce, uint8_t boundary[], size_t iterations)
//{
//    const uint64_t end_nonce = start_nonce + iterations;
//    uint8_t digs[DGST_SIZE];
//    for (uint64_t nonce = start_nonce; nonce < end_nonce; ++nonce)
//    {
//        fchainhash(dataset, mining_hash, nonce, digs);
//    }
//}
